...
# Sen çekerken: BASLANGIC_VIDEO = 0, BITIS_VIDEO = 100 olacak.
# Annen/Kardeşin çekerken: BASLANGIC_VIDEO = 100, BITIS_VIDEO = 200 olacak.
BASLANGIC_VIDEO = 100
BITIS_VIDEO = 200
# =======================================================
    ...
    for action in actions:
       ...
       # 1. HARFE BAŞLAMADAN ÖNCEKİ İLK BEKLEME EKRANI ('N' tuşu)
        while cap.isOpened():
            ...
            cv2.imshow('TID Veri Toplama', image) # Buralar image oldu
